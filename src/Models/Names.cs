...
using Random.API.Extensions;

namespace Random.API.Models
{
    public static class Names
    {
        static List<string> Left { get; set; } = new List<string> 
        {
		    "adoring",
            "affectionate",
            "agitated",
        ...
        static List<string> Right {get; set;} = new List<string>
        {
        ...
        public static string CreateNew()
        {
            ...
            var textCulture = CultureInfo.CurrentCulture.TextInfo;

            var firstName = Left[random.Next(Left.Count)].ToTitleCase();
            var lastName = Right[random.Next(Right.Count)].ToTitleCase();
